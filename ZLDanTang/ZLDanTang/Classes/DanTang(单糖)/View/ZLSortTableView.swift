...
let sortCellID = "sortTableViewCellID"

protocol ZLSortTableViewDelegate: NSObjectProtocol {
    func sortView(sortView: ZLSortTableView, didSelectSortAtIndexPath sort: String)
}

class ZLSortTableView: UIView, UITableViewDelegate, UITableViewDataSource {
    
    weak var delegate: ZLSortTableViewDelegate?
    ...
    private lazy var tableView: UITableView = {
        ...
        let nib = UINib(nibName: String(describing: ZLSortCell.self), bundle: nil)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: sortCellID) as! ZLSortCell
